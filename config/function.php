...
function getOrdersByVendorName($vendorName, $conn)
{
    ...
    $sql = "SELECT o.order_id, o.client_name, o.city, o.phone, o.order_date, o.quantity, o.status, o.product_id, p.product_name, p.price, (o.quantity * p.price) AS total
    FROM orders o
...
function insertOrder($product_id, $vendor_id, $client_name, $city, $wilaya, $phone, $quantity, $status, $conn)
{
    ...
    $sql = "INSERT INTO orders (product_id, vendor_id, client_name, city, phone, quantity, status, order_date)
            VALUES ('$product_id', '$vendor_id', '$client_name', '$city', '$phone', '$quantity', '$status', NOW())";
