                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0"><?php echo $totalShippedAmount; ?> INR</span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0"><?php echo getVendorBalance($vendorName, $conn); ?> INR</span>
                            </div>
                            <div class="col-auto">
