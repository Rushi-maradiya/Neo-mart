...
foreach ($filteredProducts as $product) {
    ...
    echo '<img src="../uploads/' . htmlspecialchars($product['image']) . '" alt="' . htmlspecialchars($product['product_name']) . '" class="image img-fluid product-thumbnail">';
    echo '<h3 class="product-title">' . htmlspecialchars($product['product_name']) . '</h3>';
    echo '<strong class="product-price">' . htmlspecialchars($product['price']) . ' INR</strong>';
    echo '</a>';
    ...
    echo '<select class="mb-3 form-select" name="selected_quantity">';
